...
/**
 * DesignHeader - 与 Editor Header 功能对齐
 */
const DesignHeader = (props: any) => {
    const { Header } = Layout;
    const { rightSiderContent, updateRightSiderType, style } = props;
    const dispatch = useDispatch();
    const items: (MenuProps['items'][number] & { key: string })[] = [
        {
            label: '渲染器设置',
            key: 'render',
        },
...
export default connect(mapStateToProps, { updateRightSiderType })(DesignHeader)
